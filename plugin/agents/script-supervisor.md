...
- **Breaks** (will read as an error on screen): the issue, the shots involved, and
  the specific fix (e.g., "sbw010_0030 has Eli looking screen-left; sbw010_0020 established him
  screen-right — flip the framing or the eyeline"; or "sbw020_0110 attaches the
  `prop_revolver_hero_aged` variant of `refs: prop_revolver` but sbw020_0100 established
