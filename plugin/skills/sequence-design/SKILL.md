...
{show}{###}_0010  Establishing — {size}, {angle}, {lens}, {move} — serves {beat} — intensity {low/med/high}
{show}{###}_0020  Master — ...
{show}{###}_0030  Coverage CU — {lens} — serves {beat} — intensity {x} — refs: char_eli, set_livingroom
...
```
