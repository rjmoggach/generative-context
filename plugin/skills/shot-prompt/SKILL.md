...
([`model-image-luma-uni-1.md`](${CLAUDE_PLUGIN_ROOT}/context/model-image-luma-uni-1.md)),
**Nano Banana / Nano Banana Pro** (Gemini Image)
([`model-image-gemini-flash.md`](${CLAUDE_PLUGIN_ROOT}/context/model-image-gemini-flash.md)),
**FLUX.2** ([`model-image-flux-pro.md`](${CLAUDE_PLUGIN_ROOT}/context/model-image-flux-pro.md)),
**Seedream** ([`model-image-seedream-4.md`](${CLAUDE_PLUGIN_ROOT}/context/model-image-seedream-4.md)).
...
- Label each shot: `**sbw010_0010 Establishing — LS, eye-level, static**`.
