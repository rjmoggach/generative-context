...
- Veo 3.1: [`references/models/model-video-google-veo-3-1.md`](${CLAUDE_PLUGIN_ROOT}/context/model-video-google-veo-3-1.md)
  — native synchronized audio.
- Luma Ray3.2: [`references/models/model-video-luma-ray3.md`](${CLAUDE_PLUGIN_ROOT}/context/model-video-luma-ray3.md)
  — keyframe control, HDR/EXR.
- Kling 3.0: [`references/models/model-video-kling-3.md`](${CLAUDE_PLUGIN_ROOT}/context/model-video-kling-3.md)
