...
- [`references/guide-location-pack.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-location-pack.md) —
...
[`references/set-template.md`](${CLAUDE_PLUGIN_ROOT}/context/set-template.md). The crew role for this
