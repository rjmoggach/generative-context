...
prevent. See [`references/guide-production.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-production.md)
...
[`references/guide-production.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-production.md) §3:
...
[`references/guide-execution.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-execution.md) §6. For
...
human per [`references/guide-presentation.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-presentation.md):
...
5. **Report in chat; present visually on request.** This skill's core output is a
   ...
   *see* the board — thumbnails, coverage, the whole show — present it per
   [`references/guide-presentation.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-presentation.md): the
