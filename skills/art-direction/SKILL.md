...
[`references/guide-color-story.md`](references/guide-color-story.md) for scheme
...
- Gemini Flash: [`references/models/model-image-gemini-flash.md`](references/models/model-image-gemini-flash.md)
